    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageClassifier
            ...
            .addOnFailureListener { e ->
                ...
                resultTextView?.text = "Inițializarea modelului a eșuat." //Failed to initialize classifier
            }
            .addOnSuccessListener {
                resultTextView?.text = "Model pregătit! Selectează o imagine."  //Classifier ready! Select an image.
